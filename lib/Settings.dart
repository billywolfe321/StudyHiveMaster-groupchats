...
import 'CustomAppBar.dart'; // Assuming this is correctly set up to include a drawer
...
class Setting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(), // Ensure this AppBar has a leading hamburger menu
      drawer: OpenDrawer(),  // Ensure this drawer has all needed navigation links
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 100),
            ElevatedButton(
              onPressed: () => navigateToPage(context, Login()),  // Adjust if this is not how you handle log out
